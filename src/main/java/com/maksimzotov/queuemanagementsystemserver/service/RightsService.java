...
public interface RightsService {
    ContainerForList<RightsModel> getRights(Localizer localizer, String email, Long locationId) throws DescriptionException;
    ...
    Boolean checkRightsInLocation(String email, Long locationId);
}
