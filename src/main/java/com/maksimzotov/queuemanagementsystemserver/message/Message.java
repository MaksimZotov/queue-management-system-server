...
public enum Message {
    PASSWORD_MUST_CONTAINS_MORE_THAN_7_SYMBOLS,
    PASSWORD_MUST_CONTAINS_LESS_THAN_65_SYMBOLS,
    PASSWORD_MUST_NOT_CONTAINS_WHITESPACES,
    ...
    SERVICE_NAME_MUST_NOT_BE_EMPTY,
    SERVICES_SEQUENCE_NAME_MUST_NOT_BE_EMPTY,
    SPECIALIST_NAME_MUST_NOT_BE_EMPTY;
